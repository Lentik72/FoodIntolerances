...
// MARK: - AI Components moved to Views/Logging/AIInsightComponents.swift
// - AllergenWarningCard
// - AIInsightResponseSheet
// - AIWarningCardRow, AIObservationCardRow, AISuggestionCardRow, AIQuestionCardRow
// - SelectableOptionButton (with accessibility)
